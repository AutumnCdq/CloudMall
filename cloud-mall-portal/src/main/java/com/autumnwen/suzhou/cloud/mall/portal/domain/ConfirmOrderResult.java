package com.autumnwen.suzhou.cloud.mall.portal.domain;

import com.autumnwen.suzhou.cloud.mall.model.UmsIntegrationConsumeSetting;
import com.autumnwen.suzhou.cloud.mall.model.UmsMemberReceiveAddress;
...
public class ConfirmOrderResult {
    //包含优惠信息的购物车信息
    private List<com.autumnwen.suzhou.cloud.mall.portal.domain.CartPromotionItem> cartPromotionItemList;
    //用户收货地址列表
    private List<UmsMemberReceiveAddress> memberReceiveAddressList;
    //用户可用优惠券列表
    private List<com.autumnwen.suzhou.cloud.mall.portal.domain.SmsCouponHistoryDetail> couponHistoryDetailList;
    //积分使用规则
    ...
    public List<com.autumnwen.suzhou.cloud.mall.portal.domain.CartPromotionItem> getCartPromotionItemList() {
        return cartPromotionItemList;
    }

    public void setCartPromotionItemList(List<com.autumnwen.suzhou.cloud.mall.portal.domain.CartPromotionItem> cartPromotionItemList) {
    ...
    public List<com.autumnwen.suzhou.cloud.mall.portal.domain.SmsCouponHistoryDetail> getCouponHistoryDetailList() {
        return couponHistoryDetailList;
    }

    public void setCouponHistoryDetailList(List<com.autumnwen.suzhou.cloud.mall.portal.domain.SmsCouponHistoryDetail> couponHistoryDetailList) {
